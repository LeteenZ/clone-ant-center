(() => {
    ...
    const tabs = $$(".tab-link-2");
    const panes = $$(".content-item-2");
    const tabActive = $(".tab-link-2.active");
    const line = $(".tabs-2 .line_2");
    ...
    tabs.forEach((tab, index) => {
      ...
      tab.onclick = function () {
        $(".tab-link-2.active").classList.remove("active");
        ...
        $(".content-item-2.active").classList.remove("active");
...
document.querySelectorAll('.tab-link-2').forEach(button => {
  button.addEventListener('click', function () {
      const tabsContainer = document.querySelector('.tabs-container-2'); // Thanh chứa các tab
...
document.addEventListener('DOMContentLoaded', function() {
  const tabsContainer = document.querySelector('.tabs-container-2');
  const prevBtn = document.querySelector('.prev-btn-2 button');
  const nextBtn = document.querySelector('.next-btn-2 button');
